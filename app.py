...
def analisar_bdr(ticker):
    try:
        ...
        if df_diario is None or len(df_diario) < 150:
            return None
...
def main():
    ...
    bdrs_top = [
        ...
        "JNJB34.SA", "PGCO34.SA", "HOME34.SA", "COCA34.SA", "MCDC34.SA", "NIKE34.SA",
        "NUBR33.SA", "VZBO34.SA", "BERK34.SA", "JPMC34.SA", "VISA34.SA", "WMTB34.SA",
        "XOMP34.SA", "ORCL34.SA", "PEP34.SA", "PFIZ34.SA", "SBUB34.SA", "TGTB34.SA"
    ]
    ...
    if st.button("🌍 Iniciar Varredura de BDRs"):
        ...
        for i, bdr in enumerate(bdrs_top):
            res = analisar_bdr(bdr)
            if res:
                hits.append({
                    "BDR": bdr.replace(".SA", ""),
                    "PREÇO": res["Preço"],
        ...
        if hits:
            ...
            st.info("Nenhum BDR atende ao setup no momento.")
